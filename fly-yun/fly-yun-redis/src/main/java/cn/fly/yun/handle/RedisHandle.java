package cn.fly.yun.handle;

import cn.fly.yun.base.BaseRedisDao;
...
public class RedisHandle implements BaseRedisDao<String, Object> {
    ...
    public Long incrementMapLong(String key, String hk, long hv) {
        return redisTemplate.boundHashOps(key).increment(hk,hv);
    }
