...
public class SubErrors {
    ...
    private static final EnumMap<SubErrorType, MainErrorType> SUBERROR_MAINERROR_MAPPINGS =
            new EnumMap(SubErrorType.class);
    ...
    static {
         ...
         */
        SUBERROR_MAINERROR_MAPPINGS.put(
                SubErrorType.ISV_NOT_AUTHENTICATED, MainErrorType.ISV_NOT_AUTHENTICATED);
        /**
         * 客户无此权限
         */
        SUBERROR_MAINERROR_MAPPINGS.put(
                SubErrorType.ISV_NOT_AUTHORIZED, MainErrorType.ISV_NOT_AUTHENTICATED);

        /**
         * 未捕获的异常
         */
        SUBERROR_MAINERROR_MAPPINGS.put(
                SubErrorType.ISP_UNCAUGHT_EXCEPTION, MainErrorType.ISP_EXCEPTION);

        /**
         * 客户端请求数据校验非法
         */
        SUBERROR_MAINERROR_MAPPINGS.put(
                SubErrorType.ISV_BEAN_VALIDATOR, MainErrorType.ISV_BAD_REQUEST);

        /**
         * oauth2验证
         */
        SUBERROR_MAINERROR_MAPPINGS.put(
                SubErrorType.ISV_OAUTH2_INVALID, MainErrorType.ISV_FORBIDDEN);

        /**
         * 业务异常
         */
        SUBERROR_MAINERROR_MAPPINGS.put(
                SubErrorType.ISP_BUSINESS_EXCEPTION, MainErrorType.SERVICE_UNAVAILABLE);
    }
